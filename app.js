...
const solarSystem = [
    ...
    // 5. Add a new key value pair to the the Earth object: the key should be 'diameter', and the value should be Earth's diameter in miles represented as a string.
          ...
          solarSystem[2].diameter = "7926 miles"
...
const system = {
    ...
    const totalSatellites = Number(system.jupiter.satellites) + Number(system.saturn.satellites) + Number(system.uranus.satellites) + Number(system.neptune.satellites);
    ...
    if (typeof system.mercury.radiusp === 'string') {
      ...
      // Log the updated radiusp value of Mercury
    ...
    // 6. Find the difference between Jupiter's momentum and Pluto's momentum. (To get momentum, you'll want the product of velocity and mass).
           // Calculate momentum (momentum = velocity * mass) for Jupiter and Pluto
           ...
           // Calculate the difference in momentum between Jupiter and Pluto
               const momentumDifference = jupiterMomentum - plutoMomentum;

               // Log the difference in momentum
